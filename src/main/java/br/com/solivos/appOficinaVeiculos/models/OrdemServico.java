...
public class OrdemServico {
    ...
    public String getFotosPintura() { return fotosPintura; }
    public void setFotosPintura(String fotosPintura) { this.fotosPintura = fotosPintura; }
    ...
    public List<OrdemPeca> getPecas() { return pecas; }
    public void setPecas(List<OrdemPeca> pecas) { this.pecas = pecas; }
}
